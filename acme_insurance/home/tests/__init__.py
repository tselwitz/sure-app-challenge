# View tests
from home.tests.views.quote_view import QuoteViewTest
...
from home.tests.models.quote import QuoteModelTest
from home.tests.models.state import StateModelTest
